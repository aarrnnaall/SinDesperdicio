...
/**
 * REST controller for managing {@link app.sindesperdicio.net.ar.domain.Nutrition}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class NutritionResource {
    ...
    public ResponseEntity<Nutrition> updateNutrition(@RequestBody Nutrition nutrition) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, nutrition.getId().toString()))
            .body(result);
    }
