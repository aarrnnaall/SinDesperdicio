...
@NgModule({
  imports: [
    ...
    SinDesperdicioSharedModule.forRoot(),
    SinDesperdicioCoreModule,
    SinDesperdicioHomeModule,
    SinDesperdicioAccountModule,
