...
import sindesperdicio.um.edu.ar.config.audit.AuditEventConverter;
import sindesperdicio.um.edu.ar.domain.PersistentAuditEvent;
...
import static sindesperdicio.um.edu.ar.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
